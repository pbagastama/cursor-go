...
>(({ className, children, ...props }, ref) => (
  <DialogPrimitive.Portal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-md p-1 opacity-70 transition-opacity hover:bg-accent hover:opacity-100 focus:outline-none">
        <X className="h-4 w-4" />
